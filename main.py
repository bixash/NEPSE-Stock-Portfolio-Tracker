...
from portfoliotracker.api import auth_router, sector_router, stock_router, transaction_router, upload_router, portfolio_router, company_router, holdings_router, sector_router, instrument_router, profile_router
